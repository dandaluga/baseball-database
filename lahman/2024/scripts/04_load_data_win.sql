...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\AllstarFull.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Appearances.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.awards_managers(player_id,award_id,year_id,lg_id,tie,notes)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\AwardsManagers.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.awards_players(player_id,award_id,year_id,lg_id,tie,notes)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\AwardsPlayers.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.awards_share_managers(award_id,year_id,lg_id,player_id,points_won,points_max,votes_first)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\AwardsShareManagers.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.awards_share_players(award_id,year_id,lg_id,player_id,points_won,points_max,votes_first)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\AwardsSharePlayers.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Batting.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\BattingPost.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.college_playing(player_id,school_id,year_id)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\CollegePlaying.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Fielding.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\FieldingOF.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\FieldingOFsplit.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\People.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Pitching.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\PitchingPost.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.salaries(year_id,team_id,lg_id,player_id,salary)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Salaries.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.schools(school_id,name_full,city,state,country)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Schools.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.series_post(year_id,round,team_id_winner,lg_id_winner,team_id_loser,lg_id_loser,wins,losses,ties)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\SeriesPost.csv' WITH CSV
 HEADER DELIMITER AS ',';
...
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\Teams.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.teams_franchises(franch_id,franch_name,active,national_association_id)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\TeamsFranchises.csv' WITH CSV
 HEADER DELIMITER AS ',';

COPY year2024.teams_half(year_id,lg_id,team_id,half,div_id,division_winner,rank,games,wins,losses)
FROM 'C:\dev\baseball\baseball-database\lahman\2024\data\TeamsHalf.csv' WITH CSV
 HEADER DELIMITER AS ',';
